...
function handleClick(page) {
    ...
    if (page === 'Daaku1') {
        if (clickCounts.Daaku1 === 1) {
            window.open("https://www.example.com", "_blank");
        } else if (clickCounts.Daaku1 === 2) {
            window.open('Daaku Maharaaj1.html', '_blank');
            clickCounts. Daaku1 = 0;  // Reset click count for Movies
        }
    }
    if (page === 'Daaku2') {
        if (clickCounts.Daaku2 === 1) {
            window.open("https://www.example.com", "_blank");
        } else if (clickCounts. Daaku2 === 2) {
            window.open('Daaku Maharaaj2.html', '_blank');
            clickCounts. Daaku2 = 0;  // Reset click count for Movies
        }
    }
    if (page === 'Daaku3') {
        if (clickCounts.Daaku3 === 1) {
            window.open("https://www.example.com", "_blank");
        } else if (clickCounts. Daaku3 === 2) {
            window.open('Daaku Maharaaj3.html', '_blank');
            clickCounts. Daaku3 = 0;  // Reset click count for Movies
        }
    }
